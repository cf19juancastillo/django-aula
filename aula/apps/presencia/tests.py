"""
    This module includes some tests for the presencia app
"""
import re
...
from .models import Impartir, ControlAssistencia, EstatControlAssistencia
from .test.DBCreatorTester import DBCreatorTester
